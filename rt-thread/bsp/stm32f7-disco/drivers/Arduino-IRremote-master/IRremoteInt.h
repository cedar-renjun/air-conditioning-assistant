...
#define TIMER_ENABLE_PWM                              IR_TIM_ENABLE
#define TIMER_DISABLE_PWM                             IR_TIM_DISABLE  
#define TIMER_DISABLE_INTR
#define pinMode(TIMER_PWM_PIN, OUTPUT)  
#define digitalWrite(TIMER_PWM_PIN, LOW)              IR_TIM_DISABLE
